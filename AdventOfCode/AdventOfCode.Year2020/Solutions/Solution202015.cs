...
{
    public class Solution202015 : ISolution
    {
        private readonly ILogger<Solution202015> _logger;
        private readonly IInputService _inputService;
        private readonly string resourceLocation = "Resources2020\\Day15.txt";
        public Solution202015(ILogger<Solution202015> logger, IInputService inputService)
        {
            _logger = logger;
        ...
        public string GetSolution()
        {
            ...
            for (var turn = gameData.Count + 1; turn <= 2020; turn++)
            {
