...
{
    public class Solution202111Part2 : ISolution
    {
        private readonly ILogger<Solution202111Part2> _logger;
        private readonly IInputService _inputService;
        private readonly string resourceLocation = "Resources2021\\Day11.txt";

        public Solution202111Part2(ILogger<Solution202111Part2> logger, IInputService inputService)
        {
            _logger = logger;
        ...
        public string GetSolution()
        {
            ...
            while(!isDone)
            {
                ...
                isDone = octopusses.Sum(o => o.Energy) == 0;
            }
