...
{
    public class Solution202117Part2 : ISolution
    {
        private readonly ILogger<Solution202117Part2> _logger;
        private readonly IInputService _inputService;
        private readonly string resourceLocation = "Resources2021\\Day17.txt";

        public Solution202117Part2(ILogger<Solution202117Part2> logger, IInputService inputService)
        {
            _logger = logger;
