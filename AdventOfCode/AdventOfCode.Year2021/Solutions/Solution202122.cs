...
{
    public class Solution202122 : ISolution
    {
        private readonly ILogger<Solution202122> _logger;
        private readonly IInputService _inputService;
        private readonly string resourceLocation = "Resources2021\\Day22.txt";

        public Solution202122(ILogger<Solution202122> logger, IInputService inputService)
        {
            _logger = logger;
        ...
        {
            var input = _inputService.GetInput(resourceLocation).Select(i => new Instruction(i, 50));
        ...
        {
            public Instruction(string input, int sizeLimit)
            {
