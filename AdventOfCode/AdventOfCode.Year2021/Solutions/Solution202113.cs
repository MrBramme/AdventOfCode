...
{
    public class Solution202113 : ISolution
    {
        private readonly ILogger<Solution202113> _logger;
        private readonly IInputService _inputService;
        private readonly string resourceLocation = "Resources2021\\Day13.txt";

        public Solution202113(ILogger<Solution202113> logger, IInputService inputService)
        {
            _logger = logger;
        ...
        public string GetSolution()
        {
            ...
            var result = grid.Sum(row => row.Count(i => i));
            return $"{result}";
        }
