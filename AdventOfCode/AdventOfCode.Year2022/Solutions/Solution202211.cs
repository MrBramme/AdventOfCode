...
{
    public class Solution202211 : ISolution
    {
        private readonly ILogger<Solution202211> _logger;
        private readonly IInputService _inputService;
        private readonly string resourceLocation = "Resources2022/Day11.txt";

        public Solution202211(ILogger<Solution202211> logger, IInputService inputService)
        {
            _logger = logger;
