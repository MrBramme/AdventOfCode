...
{
    [TestFixture]
    public class Solution202103UnitTest
    {
        private Solution202103 _sut;
        private Mock<ILogger<Solution202103>> _loggerMock;
        private Mock<IInputService> _inputService;

        [SetUp]
        public void SetUp()
        {
            _loggerMock = new Mock<ILogger<Solution202103>>();
            _inputService = new Mock<IInputService>();
            _sut = new Solution202103(_loggerMock.Object, _inputService.Object);
        }
