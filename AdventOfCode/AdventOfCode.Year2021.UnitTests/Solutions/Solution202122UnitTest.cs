...
{
    [TestFixture]
    public class Solution202122UnitTest
    {
        private Solution202122 _sut;
        private Mock<ILogger<Solution202122>> _loggerMock;
        private Mock<IInputService> _inputService;

        [SetUp]
        public void SetUp()
        {
            _loggerMock = new Mock<ILogger<Solution202122>>();
            _inputService = new Mock<IInputService>();
            _sut = new Solution202122(_loggerMock.Object, _inputService.Object);
        }

        [Test]
        public void GivenExampleInput1_ReturnsExpected()
        {
            // Given
            var expected = "39";
            var input = "on x=10..12,y=10..12,z=10..12;on x=11..13,y=11..13,z=11..13;off x=9..11,y=9..11,z=9..11;on x=10..10,y=10..10,z=10..10";
