...
{
    [TestFixture]
    public class Solution202104Part2UnitTest
    {
        private Solution202104Part2 _sut;
        private Mock<ILogger<Solution202104Part2>> _loggerMock;
        private Mock<IInputService> _inputService;

        [SetUp]
        public void SetUp()
        {
            _loggerMock = new Mock<ILogger<Solution202104Part2>>();
            _inputService = new Mock<IInputService>();
            _sut = new Solution202104Part2(_loggerMock.Object, _inputService.Object);
        }
