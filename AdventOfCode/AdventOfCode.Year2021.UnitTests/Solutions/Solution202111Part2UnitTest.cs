...
{
    [TestFixture]
    public class Solution202111Part2UnitTest
    {
        private Solution202111Part2 _sut;
        private Mock<ILogger<Solution202111Part2>> _loggerMock;
        private Mock<IInputService> _inputService;

        [SetUp]
        public void SetUp()
        {
            _loggerMock = new Mock<ILogger<Solution202111Part2>>();
            _inputService = new Mock<IInputService>();
            _sut = new Solution202111Part2(_loggerMock.Object, _inputService.Object);
        }
