...
{
    [TestFixture]
    public class Solution202108UnitTest
    {
        private Solution202108 _sut;
        private Mock<ILogger<Solution202108>> _loggerMock;
        private Mock<IInputService> _inputService;

        [SetUp]
        public void SetUp()
        {
            _loggerMock = new Mock<ILogger<Solution202108>>();
            _inputService = new Mock<IInputService>();
            _sut = new Solution202108(_loggerMock.Object, _inputService.Object);
        }
